...
export function effectiveReaderSettings(settings:ReaderSettings,mangaId:string):ReaderSettings{const titlePreset=settings.titlePresets?.[mangaId];return titlePreset?{...settings,...READER_PRESETS[normalizeReaderPreset(titlePreset)]}:settings}
