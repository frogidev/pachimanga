...
5. Run the iOS workflow manually after App Store signing credentials and provisioning are configured.
...
For direct distribution outside the Mac App Store, both code signing and notarization are required for a professional Gatekeeper experience.
